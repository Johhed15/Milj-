...
e_jord <- px_markanvandning$andel.total.jordbruksmark[
  px_markanvandning$region == "Enköping"
]

a_skog <- px_markanvandning$andel.total.skogsmark[
  px_markanvandning$region == "Älvkarleby"
]

h_bygg <- px_markanvandning$andel.bebyggd.och.anlagd.mark[
  px_markanvandning$region == "Håbo"
]
...
Enköping har lägst andel skogsmark i länet, men också länets högsta jordbruksmarsandel på `r round(e_jord*100,1)` %. Älvkarleby har länets högsta skogsmarksandel på `r round(a_skog*100,1)` %. Håbo har högst andel bebyggd och anlagd mark på `r round(h_bygg*100,1)` %.
...
Data hämtat från @kolada som hänvisar vidare till @scb_statistikdatabasen.
